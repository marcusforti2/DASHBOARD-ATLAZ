        ...
        {keys.map(key => {
          ...
          return (
            ...
            >
              ...
              <span className="text-lg font-black tabular-nums text-card-foreground leading-none">
                {val.toLocaleString("pt-BR")}
              </span>
              {goal > 0 && (
                <span className="text-[8px] text-muted-foreground leading-none">/{goal.toLocaleString("pt-BR")}</span>
              )}
